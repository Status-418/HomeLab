...
Write-Host "[Splunk Server Install] Downloading Server Applicaiont" -ForegroundColor Green 
...
Write-Host "[Splunk Server Install] Installing Server Applicaiont" -ForegroundColor Green 
...
Write-Host "[Splunk Server Install] Configuring Server To Listen For Forwarders" -ForegroundColor Green 
& 'C:\Program Files\Splunk\bin\splunk.exe' enable listen 9997 -auth $SplunkUser':'$SplunkPassword

Write-Host "[Splunk Server Install] Installing Splunk Apps" -ForegroundColor Green 
...
Write-Host "[Splunk Server Install] Restarting Server" -ForegroundColor Green
Restart-Computer